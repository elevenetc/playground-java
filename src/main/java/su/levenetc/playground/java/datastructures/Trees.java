...
public class Trees {
    ...
    public static BNode mirrorOfPerfectNonBST() {
    ...
    public static BNode unbalancedNonBST4() {
        ...
        BNode root = unbalancedNonBST();
        BNode b1 = new BTree(root).get(1);
        b1.setRight(6).setRight(7).setRight(8).setRight(9);
        return root;
    }
